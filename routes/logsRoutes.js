...
router.get('/', protect, restrictTo('super_admin', 'initiator_admin', 'approver_admin'), getLogs);
...
router.delete('/notifications/:id', protect, restrictTo('super_admin', 'initiator_admin', 'approver_admin'), deleteNotification);
